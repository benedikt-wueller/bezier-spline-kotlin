...
class DoubleBezierSpline<V : Vector<Double, V>>
@JvmOverloads constructor(closed: Boolean = false, resolution: Int = Resolution.BALANCED, override val minWeight: Double = Double.MIN_VALUE)
